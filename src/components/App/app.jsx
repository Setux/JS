...
export default class App extends React.Component {
  state = {
    todoData: [this.createTodoEl('Task 1'), this.createTodoEl('Task 2'), this.createTodoEl('Task 3')],
    buttonsData: [
    ...
    return (
      <section className="todoapp">
        ...
        <section className="main">
          {list}
          <Footer buttons={buttonsData} left={toDo} onDelete={this.onDeleteCompleted} onFilter={this.onFilter} />
        </section>
      </section>
    );
  }
